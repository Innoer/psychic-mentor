<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="left1.aspx.cs" Inherits="Alumni.Manage.left1" %>
...
.div1{text-align:center; width:160px; 
padding-top:10px;
    }
...
<body>
    ...
    <div class="left">
        <div class="div1" style="background-color: #FFFFFF">
            <div class="left_top">&nbsp;<asp:Label ID="Label1" runat="server" 
                    Font-Names="Aparajita" Font-Overline="False" Font-Underline="True" 
                    ForeColor="#336600" Text="请先登陆"></asp:Label>
            </div>
...
<ul>
  ...
  <div class="div2"><div class="xy"> </div> 校友管理</div>
      ...
      <ul>
        ...
        <li onclick="redirectContent('tab/ReviewAlumnus.aspx')"> 审核校友</li>
         </ul>
  </div>
  ...
  <div class="div2"><div class="oth"> </div> 其他管理</div>
      <div class="div3">
      <ul>
		<li onclick="redirectContent('tab/DonationsManagement.aspx')"> 捐赠管理</li>
