...
namespace Alumni
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="Alumni")]
...
namespace AlumniDB
{
    ...
    partial void OnContentChanged();
		...
		[Association(Name="Users_Articles", Storage="_Users", ThisKey="PublishUserID", OtherKey="UserID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Users Users
		{
			get
			{
		...
		[Association(Name="Columns_Articles", Storage="_Columns", ThisKey="ColumnID", OtherKey="ColumnID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
